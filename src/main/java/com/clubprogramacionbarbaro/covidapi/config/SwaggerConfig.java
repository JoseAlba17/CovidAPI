...
public class SwaggerConfig {
	...
	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("CovidApi Documentation",
			"This api helps the hospitals to always have the necessary material during the Covid-19 pandemy", "1.0",
			"urn:tos", DEFAULT_CONTACT, "Apache 2.0", "http://www.apache.org/licences/LICENSE-2.0", new HashSet<>());
